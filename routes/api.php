...
Route::middleware('HandleCors')->prefix('masterAdmin')->group(function(){
...
// organization
Route::middleware('HandleCors')->prefix('organization')->group(function(){
...
//client
Route::middleware('HandleCors')->prefix('client')->group(function(){
